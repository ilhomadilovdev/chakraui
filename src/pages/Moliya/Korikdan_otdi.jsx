...
function Korikdan_otdi() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setLoading(true)
            try {
                const response = await fetch('https://ventum-internship-backend.bis-apps.com/api/finances/verified/pagination/0', {
                    headers: {
    ...
    return (
        <div>
        <Text mt="4" color='blue' fontSize={"xl"}>Прошел проверку </Text>
