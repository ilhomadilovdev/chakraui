...
function Yetkazish() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setLoading(true)
            try {
                const response = await fetch('https://ventum-internship-backend.bis-apps.com/api/finances/delivered/pagination/0', {
                    headers: {
    ...
    return (
        <div>
            <Text mt="4" color='blue' fontSize={"xl"}>Доставленные </Text>
